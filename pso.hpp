...
class Swarm {
	...
	public:
		...
		std::vector< double > find_food (void) {
            ...
            std::vector<double > errors,iters;//********************1
			for (int iter = 0; iter < limit; iter++) {
				...
				std::cout<<"gbest is:"<<gbest_err<<std::endl;
                ...
                errors.push_back(pso_rosenbrock (gbest, nullptr));//*****************2
				iters.push_back(iter);//********************3
			}
			//**********************4
